...
import (
	...
	dStub "github.com/chouandy/migrate/database/stub"
	"github.com/chouandy/migrate/source"
	sStub "github.com/chouandy/migrate/source/stub"
)
...
func ExampleNewWithDatabaseInstance() {
	...
	// `import "github.com/chouandy/migrate/database/postgres"`
...
func ExampleNewWithSourceInstance() {
	...
	// `import "github.com/chouandy/migrate/source/stub"`
