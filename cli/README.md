...
[Release Downloads](https://github.com/chouandy/migrate/releases)

```
$ curl -L https://github.com/chouandy/migrate/releases/download/$version/migrate.$platform-amd64.tar.gz | tar xvz
```
...
```
$ go get -u -d github.com/chouandy/migrate/cli
$ cd $GOPATH/src/github.com/chouandy/migrate/cli
$ dep ensure
$ go build -tags 'postgres' -o /usr/local/bin/migrate github.com/chouandy/migrate/cli
```
...
1. Support for build constraints will be removed in the future: https://github.com/chouandy/migrate/issues/60
